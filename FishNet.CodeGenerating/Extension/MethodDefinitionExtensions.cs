...
namespace FishNet.CodeGenerating.Extension
{
    ...
    internal static class MethodDefinitionExtensions
    {
        ...
        /// </summary>
        public static Mono.Cecil.Cil.OpCode GetCallOpCode(this MethodDefinition md)
        {
            if (md.Attributes.HasFlag(MethodAttributes.Virtual))
                return Mono.Cecil.Cil.OpCodes.Callvirt;
            else
                return Mono.Cecil.Cil.OpCodes.Call;
        }
        /// <summary>
        /// Returns the proper OpCode to use for call methods.
        /// </summary>
        public static Mono.Cecil.Cil.OpCode GetCallOpCode(this MethodReference mr, CodegenSession session)
        {
